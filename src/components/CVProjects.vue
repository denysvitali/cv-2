...
<template>
  <div class="projects">
    ...
    <div class="projects-list">
      <div class="see-more">
        This is just an incredibly small part of the many (190+) Open Source
        projects I've created. Check out my
        <a href="https://github.com/denysvitali/">GitHub profile</a>!
      </div>
